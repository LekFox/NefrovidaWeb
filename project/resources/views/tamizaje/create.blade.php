...
<div class="container"><form action="{{url('/beneficiario/'.$beneficiario->id.'/tamizaje')}}" method="post">
  @csrf
  ...
  <h1 id="AntecedentesTitulo" class="text-center bluenefro"><i class="bi bi-person-lines-fill"></i> Registrar Tamizaje de {{ $beneficiario->nombreBeneficiario }}</h1>
