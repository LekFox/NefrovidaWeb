...
<div class="form-row">
    ...
    <div class="col-4">
        <textarea type="number" class="form-control" placeholder="Superficie Corporal (m2)" id="superficieCorporal" name="superficieCorporal" maxlength="200" rows="1">{{ isset($depuracioncreatinina->superficieCorporal) ? $depuracioncreatinina->superficieCorporal: '' }}</textarea>
    </div>
</div>
...
<div class="form-row">
    <div class="col-4">
        <textarea type="number" class="form-control" placeholder="Depuración de Creatina" id="creatininaDepuracion" name="creatininaDepuracion" maxlength="200" rows="1">{{ isset($depuracioncreatinina->creatininaDepuracion) ? $depuracioncreatinina->creatininaDepuracion: '' }}</textarea>
    </div>
    <div class="col-2">
    </div>
    <div class="col-4">
