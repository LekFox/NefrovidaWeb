...
<div class="container"><form action="{{url('/nefropediatria/'.$nefropediatria->id)}}" method="post">
  ...
  <h1 id="AntecedentesTitulo" class="text-center bluenefro"><i class="bi bi-x-diamond"></i> Registrar Consulta</h1>
        ...
        <div class="row setup-content" id="step-1">
            ...
            <div class="col-1">
                ...
                <div class="col-10">
                    ...
                    <br>
                    <input type="hidden" id="beneficiario_id" name="beneficiario_id" value="{{ $nefropediatria->beneficiario_id }}">

                <div class="container">
                    <div class="form-group">
                        <label for="padecimiento">Padecimiento</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" name="padecimiento" value="{{ isset($nefropediatria->padecimiento)?$nefropediatria->padecimiento:old('padecimiento') }}" id="padecimiento" rows="6">{{ isset($nefropediatria->padecimiento)?$nefropediatria->padecimiento:old('padecimiento') }}</textarea>
                    </div>
            <div class="col-1">
            </div>                    
            ...
            <div class="col-1">
                ...
                <div class="container">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" name="mental" value="{{ isset($nefropediatria->mental)?$nefropediatria->mental:old('mental') }}" id="mental" rows="6">{{ isset($nefropediatria->mental)?$nefropediatria->mental:old('mental') }}</textarea>
                    </div>
            <div class="col-1">
            </div>                    
            </div>
            ...
            <div class="col-1">
                ...
                <div class="container">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" name="observaciones" value="{{ isset($nefropediatria->observaciones)?$nefropediatria->observaciones:old('observacioneso') }}" id="dobservaciones" rows="6">{{ isset($nefropediatria->observaciones)?$nefropediatria->observaciones:old('observaciones') }}</textarea>
                    </div>
            <div class="col-1">
            </div>                    
            </div>
            ...
            <div class="col-1">
                ...
                <div class="container">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" name="diagnostico" value="{{ isset($nefropediatria->diagnostico)?$nefropediatria->diagnostico:old('diagnostico') }}" id="diagnostico" rows="6">{{ isset($nefropediatria->diagnostico)?$nefropediatria->diagnostico:old('diagnostico') }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="tratamiento">Tratamiento</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" name="tratamiento" value="{{ isset($nefropediatria->tratamiento)?$nefropediatria->tratamiento:old('tratamiento') }}" id="tratamiento" rows="6">{{ isset($nefropediatria->tratamiento)?$nefropediatria->diagnostico:old('tratamiento') }}</textarea>
                    </div>
                    <div class="text-center">
                          <button class="btn btn-primary prevBtn btn-lg pull-left" type="button"><i class="bi bi-chevron-left"></i> Anterior</button>
