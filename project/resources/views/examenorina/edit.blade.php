...
<div class="container"><form action="{{url('/examenorina/'.$examenorina->id)}}" method="post">
  ...
  <h1 id="AntecedentesTitulo" class="text-center bluenefro"><i class="bi bi-eyedropper"></i> Editar Examen General de Orina de {{ $examenorina->beneficiario->nombreBeneficiario }}</h1>
  <a href="{{ url('/examenorina/'.$examenorina->id) }}" class="btn btn-primary"><i class="bi bi-arrow-left"></i> Regresar </a>
  <br>
  <br>
...
<div class= "row">
  ...
  <div class="form-row">
      <div class="col-4">
        <input type="hidden" id="id" name="id" value="{{ $examenorina->id }}">
