        ...
        <div class= "row">
          <div class= "col-sm">
            ...
            <div class="col-sm text-center">
              ...
              <a href="{{ url('/beneficiario/'.$beneficiario->id.'/riesgos/create') }}" class="btn btn-primary "><i class="bi bi-plus-circle"></i> Registrar Factores de Riesgo</a>
              @endcan
              ...
              @endif
              @if($beneficiario->factoresDeRiesgo != NULL)
              <a href="{{ url('riesgos/'.$beneficiario->id)}}" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-lines-fill" viewBox="0 0 16 16">
