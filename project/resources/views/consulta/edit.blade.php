...
<div class="container"><form action="{{url('/consulta/'.$consulta->id)}}" method="post">
  ...
  <h1 id="consultaTitulo" class="text-center bluenefro"><i class="bi bi-person-lines-fill"></i> Editar Consulta de {{ $consulta->beneficiario->nombreBeneficiario }}</h1>
  <a href="{{ url('/consulta/'.$consulta->id) }}" class="btn btn-primary"><i class="bi bi-arrow-left"></i> Regresar </a>
    ...
    <div class="stepwizard col">
        <div class="stepwizard-row setup-panel">
            <div class="stepwizard-step">
                ...
                <p><i class="bi bi-person-fill"></i> Padecimiento Actual</p>
            </div>
            <div class="stepwizard-step">
